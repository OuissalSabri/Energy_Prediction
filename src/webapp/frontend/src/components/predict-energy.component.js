...
export default class Predict extends Component {
  ...
  // ... (inside the fetchData method in your React component)
  fetchData = (token) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        let isPredictionComplete = res.data.end;
        ...
        if (isPredictionComplete) {
          ...
          // Prediction is still in progress, you can update the state or handle accordingly
      ...
      .catch((err) => {
        ...
        this.setState({
          ...
          type: "danger",
          interval: null,
          data: [], // Set data to an empty array to handle potential errors
        });
      })
      .finally(() => {
        // Add logic to check if the prediction is complete and handle accordingly
        if (this.state.interval === null) {
          console.log("Prediction is complete");
